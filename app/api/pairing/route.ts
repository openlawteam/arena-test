...
import { createPairing, updatePairingPrompt } from "@/lib/pairing-store";
...
export async function POST(request: Request) {
  try {
    ...
    const prompt = buildGrokSetupPrompt(origin, pairing.pairingCode);
    await updatePairingPrompt(pairing.claimSecret, prompt);
